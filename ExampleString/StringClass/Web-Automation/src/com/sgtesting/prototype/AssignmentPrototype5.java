...
public class AssignmentPrototype5 {
	...
	private void createuser(String a,String b,String c,String d,String e,String f)
	{
		try {
			...
			Thread.sleep(1000);
			//validation
			WebElement ele=h.findElement(By.xpath("//*[@id='userListTableContainer']/table/tbody/tr[6]/td[1]"));
	...
	{
		return new Object[][] {{"Harish","Lokare","lokarehari@gmail.com","harish","lokare123","lokare123"},{"Vani","ks","vani@gmail.com","vani","vani123","vani123"},{"karisma","bs","karisma@gmailcom","karisma","karisma123","karisma123"}};
	}
}
