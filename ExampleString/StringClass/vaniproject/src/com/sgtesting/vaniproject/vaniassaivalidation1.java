...
public class vaniassaivalidation1 {
	...
	public void deleteuser() 
	{
		try {
			...
			o8.accept();
			Thread.sleep(800);
			WebElement o6= o1.findElement(By.xpath("//*[@id='userListTableContainer']/table/tbody/tr[2]/td[1]/table/tbody/tr/td/div[1]/span[2]"));
			Assert.assertFalse(o6.getText().equals("puppy, chintu"));
