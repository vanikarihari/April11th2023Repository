...
public class AssignmentPrototype3 {
	...
	private void createuser(String a,String b,String c,String d,String e,String f)
	{
		try {
			...
			Assert.assertTrue(ele.getText().equals("Jerry, Tom"));
			Thread.sleep(1000);
		}catch(Exception g)
		{
			g.printStackTrace();
	...
	{
		return new Object[][] {{"Tom","Jerry","tomandjerry@gmail.com","tom","jerry123","jerry123"}};
	}
